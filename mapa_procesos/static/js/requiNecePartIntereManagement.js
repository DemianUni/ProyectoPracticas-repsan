document.addEventListener('DOMContentLoaded', function () {
    ...
    var btnInsertar = document.getElementById('insertar_requinecepartintere')
    ...
    btnInsertar.onclick = function () {
        const url = `/crear-documento/RequisitosNecesidadesPartesInteresadas_globales/RequisitosNecesidadesPartesInteresadas_globales/` // Construir la URL
        loadForm(url)
    }

    // Manejar clics en botones de eliminar
    document.addEventListener('click', function (event) {
        if (event.target.matches('[id^="eliminar_requinecepartintere_"]')) {
            event.preventDefault()
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = `/eliminar-documento/RequisitosNecesidadesPartesInteresadas_globales/${documentId}/`
    ...
    function cargarDocumentos() {
        ...
        fetch(`/buscar-requisitos-legales-normativos-epecificos/RequisitosNecesidadesPartesInteresadas_globales/`)
            ...
            .then((data) => {
                document.getElementById('contenido-principal-requinecepartintere').innerHTML = data
            })
            .catch((error) => {
